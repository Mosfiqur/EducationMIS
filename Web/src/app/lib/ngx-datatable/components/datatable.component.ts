  ...
  template: `
    <div
      ...
      <datatable-body 
        ...
        (treeAction)="onTreeAction($event)" style="max-height:42vh;" >
      </datatable-body>
      
      <datatable-footer style="position:sticky; bottom:0; display:block; width:100%;background-color:white;"
      *ngIf="footerHeight"
      [rowCount]="rowCount"
      [pageSize]="pageSize"
      [offset]="offset"
...
export class DatatableComponent implements OnInit, DoCheck, AfterViewInit {
  ...
  get allRowsSelected(): boolean {
    ...
    if (this.selectAllRowsOnPage) {
      ...
      const rowsOnPage = this.rows != null ? this.rows.length : indexes.last - indexes.first;
  ...
  */
  ...
  onHeaderSelect(event: any): void {
    ...
    if (this.selectAllRowsOnPage) {
      ...
      var rowCount=this.rows!=null?this.rows.length:(last - first);
      const allSelected = this.selected.length === rowCount;
