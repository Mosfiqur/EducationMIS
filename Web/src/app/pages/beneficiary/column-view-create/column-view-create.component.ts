...
export class ColumnViewCreateComponent implements OnInit {
  ...
  loadColumns() {
    var data = this.httpClientService.getAsync(ApiConstant.GetAllBeneficiaryColumn + '?EntityTypeId=' + EntityType.Beneficiary)
      .then((data) => {
  ...
  saveDynamicView() {
    ...
    this.httpClientService.postAsync(ApiConstant.SaveBeneficiaryGridView, this.gridView)
    .then(a=>
      {
