 ...
 * 1. User ViewModel
 * */
public class OfflineBeneficiaryInstanceListFragment extends BaseFragment implements IMoveToNextPage {
    private View view;
    private RecyclerView collect_facility_recycler;
    private BeneficiaryScheduleAdapter benificaryScheduleAdapter;
    private LinearLayoutManager linearLayoutManager;
    public OfflineBeneficiaryInstanceListFragment listener;
    ...
    public void initViews(){
        ...
        scheduledInstances = new ArrayList<>(db.getBeneficiaryDataAccess().getBeneficiarySchedule());
    ...
    public void moveToNextPage(int id, String scheduleName, String scheduleDate, String endDate, ScheduledInstance instance) {
        ...
        System.out.println(Singleton.getInstance().getIdInstance());

        FacilityListFragment fragment = getFacilityListFragment(EntityType.Beneficiary.getIntValue(), OperationMode.Offline.getIntValue(), instance);
