...
public class UploadBeneficiarySchedule extends BaseFragment implements IMoveToNextPage {
    private View view;
    private RecyclerView collect_facility_recycler;
    private BeneficiaryScheduleAdapter benificaryScheduleAdapter;
    private LinearLayoutManager linearLayoutManager;
    public UploadBeneficiarySchedule listener;
    ...
    public void moveToNextPage(int id, String scheduleName, String scheduleDate, String endDate, ScheduledInstance instance) {
        ...
        FacilityListFragment fragment = getFacilityListFragment(EntityType.Beneficiary.getIntValue(), OperationMode.Upload.getIntValue(), instance);
